      ...
      <li className={ `carditem ${cardColor()} ${toggleClass.active ? 'is-flipped' : null} ` }>
         ...
         {current.matches("taskcomplite") &&
            <div className='carditem-complite'>
               ...
               <svg className='carditem-welldone-img' width="67" height="51" viewBox="0 0 67 51" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <p className='carditem-complite-points'>You earned { reward } Help Coins! </p>
            </div>
         }
      </li>
   )
